 ...
 * @brief This class represents the KeyTile object
 * @details This class represents the KeyTile object. In our game, these are the three tiles you see hovering in the top left
...
public:
    ...
    KeyTile();
    /**
     * @brief KeyTile Constructor
     * @details Constructor for KeyTile object with parameters for key instance variables
    ...
    /**
     * @brief getXPos
     * @details Function that returns the default x position of this keyTile object
     * @return the x position of this keyTile object
     */
    int getXPos();
    /**
     * @brief getYPos
     * @details Function that returns the default y position of this keyTile object
     * @return the y position of this keyTile object
     */
    int getYPos();
    /**
     * @brief isClicked
     * @details Function that checks if this keyTile object has been clicked
     * @return boolean that represents whether this keyTile has been clicked
     */
    bool isClicked();
    /**
     * @brief isPlaced
     * @details Function that checks if this keyTile object has been placed
     * @return boolean that represents whether this keyTile has been placed
     */
    bool isPlaced();
    /**
     * @brief setIsClicked
     * @details Function that sets the isClicked boolean of this keyTile object to the specified boolean
     * @param val the boolean value to be set
     */
    void setIsClicked(bool val);
    /**
     * @brief setIsPlaced
     * @details Function that sets the isPlaced value of this keyTile object to the specified boolean
     * @param val the boolean value to be set
     */
    void setIsPlaced(bool val);
    /**
     * @brief processInput
     * @details Function that processes the user mouse input to determine whether this keyTile has been clicked, placed or is still at its default location
    ...
    /**
     * @brief draw
     * @details Function to draw this keyTile object
