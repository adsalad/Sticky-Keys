 ...
 * @brief This class represents the playable character object.
 * @details This class represents the player object. There will only be one of these that exist in a game at any time as
...
public:
     ...
     * @details This constructor for the player class takes in parameters to set key instance variables
    ...
    /**
     * @brief getXPos
     * @details Function that returns the current x position of this player object
     * @return x position of this player object
     */
    float getXPos();
    /**
     * @brief getYPos
     * @details Function that returns the current y position of this player object
     * @return y position of this player object
     */
    float getYPos();
    /**
     * @brief getXVel
     * @details Function that returns the current x velocity of this player object
     * @return x velocity of this player object
     */
    float getXVel();
    /**
     * @brief getYVel
     * @details Function that returns the current y velocity of this player object
     * @return y velocity of this player object
     */
    float getYVel();
    /**
     * @brief setXPos
     * @details Function that sets the x position of this player object to the specified value
     * @param xPos the value that this player's x position will be set to
     */
    void setXPos(float xPos);
    /**
     * @brief setYPos
     * @details Function that sets the y position of this player object to the specified value
     * @param yPos the value that this player's y position will be set to
     */
    void setYPos(float yPos);
    /**
     * @brief setXVel
     * @details Function that sets the x velocity of this player object to the specified value
     * @param xVel the value that this player's x velocity will be set to
     */
    void setXVel(float xVel);
    /**
     * @brief setYVel
     * @details Function that sets the y velocity of this player object to the specified value
     * @param yVel the value that this player's y velocity will be set to
     */
    void setYVel(float yVel);
    /**
     * @brief setMoveLeft
     * @details Function that sets the boolean that determines whether the player can move left to the specified value
    ...
    /**
     * @brief setMoveRight
     * @details Function that sets the boolean that determines whether the player can move right to the specified value
    ...
    /**
     * @brief setCanJump
     * @details Function that sets the boolean that determines whether the player can jump to the specified value
     * @param val the value that the boolean representing whether the player can jump will be set to
     */
    void setCanJump(bool val);
    /**
     * @brief processInput
     * @details Function that processes the keyboard input from the user to determine how the player object moves
    ...
    /**
     * @brief draw
     * @details Function that draws the player object
     * @param currentLevel reference to the current level
    ...
    /**
     * @brief setFlag
     * @details Function that sets the boolean that represents whether or not checkpoint flag has been passed to specified value
    ...
    /**
     * @brief getFlag
     * @details Function that returns the current value of the boolean that represents whether the checkpoint has been passed by the player
     * @return the boolean that represents whether the checkpoint has been passed by the player
     */
    bool getFlag();
    /**
     * @brief getDeathStatus
     * @details Function that returns the current value of the boolean that represents whether the player has died
     * @return the boolean that represents whether the player has died
     */
    bool getDeathStatus();
    /**
     * @brief isAtGoal
     * @details Function that returns the current value of the boolean that represents whether the player has reached the end of the level
     * @return the boolean that represents whether the player has reached the end of the level
     */
    bool isAtGoal();
    /**
     * @brief setDeahStatus
     * @details Function that sets the boolean representing whether the player has died to the specified value
     * @param val the value that the boolean representing whether the player has died will be set to
     */
    void setDeathStatus(bool val);
    /**
     * @brief death
     * @details Function that is called when the player has died. Resets the position of the player and restores all movement
     */
    void death();
    /**
     * @brief win
     * @details Function that is called when the player has reached the end of the level. Resets the position of the player, restores all movement and resets flag booleans
     */
    void win();
};
